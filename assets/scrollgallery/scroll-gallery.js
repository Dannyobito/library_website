(() => {
  ...
  function applyScrollAnimation() {
    ...
    galleryWrappers.forEach((galleryWrapper) => {
      ...
      const initialTransform1 = gridContainer1
        ? getComputedStyle(gridContainer1).transform
        : null;
      const initialTransform2 = gridContainer2
        ? getComputedStyle(gridContainer2).transform
        : null;
      const initialTransform3 = gridContainer3
        ? getComputedStyle(gridContainer3).transform
        : null;

      function updateScrollAnimation() {
        const scrollPosition = window.scrollY;
        const screenHeight = window.innerHeight;
        const galleryBlockTop =
          galleryWrapper.getBoundingClientRect().top + window.scrollY;
        const distanceFromTop = galleryBlockTop - screenHeight;

        if (scrollPosition >= distanceFromTop) {
          const matrix1 = initialTransform1
            ? new DOMMatrix(initialTransform1)
            : null;
          const matrix2 = initialTransform2
            ? new DOMMatrix(initialTransform2)
            : null;
          const matrix3 = initialTransform3
            ? new DOMMatrix(initialTransform3)
            : null;
          ...
          if (matrix1) {
            ...
            if (
              numItems1 >= 8 &&
              !gridContainer1.classList.contains("moving-left")
            ) {
              matrix1.m41 = -2000;
            }
            ...
            switch (true) {
              ...
              case gridContainer1.classList.contains("moving-right"):
                translateX1 =
                  matrix1.m41 + (scrollPosition - distanceFromTop) * 1;
                break;
          ...
          if (matrix2) {
            ...
            if (
              numItems2 >= 8 &&
              gridContainer2.classList.contains("moving-left")
            ) {
              matrix2.m41 = -2000;
            }
            ...
            switch (true) {
              ...
              case gridContainer2.classList.contains("moving-right"):
                translateX2 =
                  matrix2.m41 + (scrollPosition - distanceFromTop) * 1;
                break;
          ...
          if (matrix3) {
            ...
            if (
              numItems3 >= 8 &&
              !gridContainer3.classList.contains("moving-left")
            ) {
              matrix3.m41 = -2000;
            }

            let translateX3 =
              matrix3.m41 + (scrollPosition - distanceFromTop) * 1;
